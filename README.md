...
You may also compile your own .whl files, by running `python setup_mypyc.py bdist_wheel`. This works if you have an appropriate version of Python, MyPy, and a compiler like MSVC installed.
